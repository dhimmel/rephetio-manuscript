...
from [dhimmel/rephetio-manuscript@d9e3872](https://github.com/dhimmel/rephetio-manuscript/tree/d9e38726e7390bc7feb45d33239c5fcea925cc02)
on August 31, 2017.
</em></small>
...
](https://think-lab.s3.amazonaws.com/m/figures/29.png){#fig:hetionet}
...
We evaluated all 1,206 metapaths that traverse from compound to disease and have length of 2–4 (Figure {@fig:features}A). To control for the different degrees of nodes, we used the degree-weighted path count (_DWPC_) — which downweights paths going through highly-connected nodes [@WkPlH1ds] — to assess path prevalence. In addition, we compared the performance of each metapath to a baseline computed from permuted networks. Hetnet permutation preserves node degree while eliminating edge specificity, allowing us to isolate the portion of unpermuted metapath performance resulting from actual network paths. We refer to the permutation-adjusted performance measure as Δ AUROC.
...
](https://think-lab.s3.amazonaws.com/m/figures/33.png){#fig:features}
...
](https://think-lab.s3.amazonaws.com/m/figures/32.png){#fig:performance}
...
](https://think-lab.s3.amazonaws.com/m/figures/36.png){#fig:bupropion_nicotine}
...
](https://think-lab.s3.amazonaws.com/m/figures/37.png){#fig:epilepsy}
...
](https://think-lab.s3.amazonaws.com/m/figures/30.png){#fig:contribution}

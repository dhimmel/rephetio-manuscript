...
bibliography:
- content/manual-references-freeze.json
...
+ **Antoine Lizee**
  <br>
    ...
    · ![Twitter icon](images/twitter.svg){.inline_icon width=16 height=16}
    [A_Lizee](https://twitter.com/A_Lizee)
    <br>
  <small>
...
+ **Leo Brueggeman**
  <br>
    ...
    · ![Twitter icon](images/twitter.svg){.inline_icon width=16 height=16}
    [LeoBman](https://twitter.com/LeoBman)
    <br>
  <small>
...
+ **Dexter Hadley**
  <br>
    ...
    · ![Twitter icon](images/twitter.svg){.inline_icon width=16 height=16}
    [iDrDex](https://twitter.com/iDrDex)
    <br>
  <small>
...
+ **Ari Green**
  <br>
    ![ORCID icon](images/orcid.svg){.inline_icon width=16 height=16}
    [0000-0001-9275-3066](https://orcid.org/0000-0001-9275-3066)
    <br>
  <small>
     Department of Neurology, University of California, San Francisco
  </small>
...
+ **Pouya Khankhanian**
  <br>
    ![ORCID icon](images/orcid.svg){.inline_icon width=16 height=16}
    [0000-0001-8075-4176](https://orcid.org/0000-0001-8075-4176)
    <br>
  <small>
...
+ **Sergio E. Baranzini**
  <br>
    ...
    · ![GitHub icon](images/github.svg){.inline_icon width=16 height=16}
    [sebaran](https://github.com/sebaran)
    <br>
  <small>
     Department of Neurology, University of California, San Francisco
  </small>
...
::: {#correspondence}
✉ — Correspondence possible via [GitHub Issues](https://github.com/dhimmel/rephetio-manuscript/issues)
...
Only binding relationships to single proteins with affinities of at least 1 μM (as determined by K<sub>d</sub>, Kᵢ, or IC₅₀) were selected from the October 2015 release of BindingDB [@doi:10.15363/thinklab.d53; @doi:10.5281/zenodo.33987].
...
| [hetio-dag](http://het.io/disease-genes/) | GiG |  | 4 | [@doi:10.1371/journal.pcbi.1004259; @doi:10.15363/thinklab.d85; @doi:10.5281/zenodo.48443] |
...
Each band represented the cumulative contribution of a Thinklab user to [discussions](https://think-lab.github.io/p/rephetio/discussion/) in Project Rephetio [@doi:10.15363/thinklab.d200].
...
All software and datasets from Project Rephetio are publicly available on [GitHub](https://git.io/v5zvX "Project Rephetio GitHub Repositories"), [Zenodo](https://goo.gl/FMiqHq "Project Rephetio Zenodo Records"), or [Figshare](https://doi.org/ccq3 "Project Rephetio Collection on Figshare") [@doi:10.6084/m9.figshare.c.2861359.v1].
